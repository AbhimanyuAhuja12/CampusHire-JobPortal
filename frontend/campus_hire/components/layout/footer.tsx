        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Connecting talented students with amazing career opportunities worldwide.
            </p>
          ...
          <div>
            ...
            <form className="space-y-2">
              <Input type="email" placeholder="Your email address" className="bg-white dark:bg-gray-800" required />
              <Button
                type="submit"
